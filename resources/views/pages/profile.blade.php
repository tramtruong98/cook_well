    ...
    <div class="container rounded bg-white mt-5 mb-5">
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" src="{{ Auth::user()->avatar }}" width="200" height="200">
                    <br>
            ...
            <div class="col-md-9 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Password</label><input type="password" class="form-control" placeholder="enter phone number" value="{{ Auth::user()->email }}"></div>
                    </div>
                    ...
                    <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="">Save Profile</button></div>
                </div>
            </div>
        </div>
    </div>
