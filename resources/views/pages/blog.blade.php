            ...
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    ...
                    <p><a href="#" type="submit" class="btn btn-primary" data-toggle="modal" data-backdrop="static"
                        data-keyboard="false" data-target="#myModal">Create new recipe!</a></p>
                    @endauth
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-12 d-flex ftco-animate">
                                <div class="blog-entry align-self-stretch d-md-flex">
                                    ...
                                    <div class="text d-block pl-md-4">
                                        ...
                                        <p>{{ $post->recipe->title }}</p>
                                        <p><a href="/blog/{{ $post->id }}" class="btn btn-primary py-2 px-3">Read
                                                more</a></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="/blog/post" enctype="multipart/form-data">
                                    ...
                                    <div class="input-group">
                                        <input class="input--style-2" type="text" placeholder="Name of course" id="name"
                                            name="name">
                                    </div>
                                    <div class="input-group">
                                        <input class="input--style-2" type="text" placeholder="Tittle" name="title" id="title">
                                    </div>
                                    <div class="input-group">
                                    ...
                                    <div class="input-group">
                                        <input class="input--style-2" type="number" placeholder="How long does it takes?" name="minutes" id="minutes">
                                    </div>
                                    ...
                                    <div class="input-group">
                                        <input class="input--style-2" type="text" placeholder="What do you feel about this recipe?" name="title_for_course" id="title_for_course">
                                    </div>
                                    <div class="p-t-30">
