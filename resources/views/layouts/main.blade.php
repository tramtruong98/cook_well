                    ...
                    <div class="media block-6 services mb-md-0 mb-4">
                        <a href="/category/{{ $category->id }}">
                            ...
                            @if ($category->name == 'Breakfast')
                                <div
                                    class="icon bg-color-2 active d-flex justify-content-center align-items-center mb-2">
                                    <span class="flaticon-coffee-cup"></span>
                                </div>
                            @endif
                            @if ($category->name == 'Daily meal')
                                <div
                                    class="icon bg-color-3 active d-flex justify-content-center align-items-center mb-2">
                            ...
                            @if ($category->name == 'Western food')
                                <div
                                    class="icon bg-color-5 active d-flex justify-content-center align-items-center mb-2">
        ...
        <div class="row">
            @foreach ($posts as $post)
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="/blog/{{ $post->id }}" class="img-prod"><img class="img-fluid"
                                src="{{ asset("img/products/$post->image") }}" alt="Colorlib Template">
